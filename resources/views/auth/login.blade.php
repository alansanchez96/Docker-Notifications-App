...
@endif
<form action="{{ route('login') }}" class="w-3/4 xl:w-2/6 mx-auto my-10 p-10 rounded-xl bg-stone-300 " method="post">
    @csrf
    ...
    <div>
        ...
        <input type="text" id="email" name="email" placeholder="Escribe tu email"
            class="block w-full p-2 text-gray-900 border border-black rounded-lg bg-transparent sm:text-xs focus:ring-blue-500 focus:border-blue-500">
    </div>
    <div>
